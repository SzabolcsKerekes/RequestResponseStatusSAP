		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Request Response Project",
									"targetURL": "#reqresproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"reqresproject-display": {
								"semanticObject": "reqresproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=reqresproject",
									"url": sap.ui.require.toUrl("reqresproject")
								}
							}
						}
					}
